...
menu:
  dados_pos_2022:
    parent: Unidade 3
    weight: 15
title: Lab 3.2 - `dados categóricos`
toc: true
type: docs
weight: 15
---
...
- Faça o download do arquivo disponível no ***link***   
- Resolva as questões.   
- Gere um tipo de documento .Rmd de sua preferência.   
- Envie por email (renataoliveira@gmail.com ou renataoliveira@cefetmg.br) o arquivo .Rmd e o arquivo gerado.
