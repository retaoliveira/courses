...
Fiquem à vontade para utilizar a ferramenta que o grupo escolher. O envio será feito pela atividade aberta no Paper Dropbox. Caso haja links, por favor, incluam no documento. O valor deste trabalho é **30 pontos**.

O prazo para conclusão desta atividade será dia **11/07**.
