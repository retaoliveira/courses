...
# Tópicos Especiais Mercadológicos: Geomarketing
...
- Fundamentos de geomarketing e inteligência territorial aplicada a mercados;
- Relações entre espaço geográfico, consumo e localização;
- Fontes de dados socioeconômicos, demográficos, territoriais e mercadológicos;
- Geocodificação, análise espacial, segmentação territorial e definição de áreas de influência;
- Uso de Sistemas de Informação Geográfica, bases públicas e dados corporativos para apoio à tomada de decisão;
- Aplicações em expansão de redes, localização de pontos de venda, análise de concorrência, logística, serviços públicos e planejamento urbano;
- Ética, privacidade e limites do uso de dados georreferenciados.

## Objetivos de aprendizagem

Ao final da disciplina, o estudante deverá ser capaz de:

1. Compreender os fundamentos conceituais do geomarketing e sua relação com marketing, geografia, estatística e sistemas de informação.
2. Identificar e avaliar fontes de dados espaciais, socioeconômicos, demográficos e mercadológicos.
3. Utilizar ferramentas de SIG para geocodificação, visualização, cruzamento e análise de dados territoriais.
4. Analisar padrões espaciais de consumo, concorrência, acessibilidade e localização.
5. Delimitar áreas de influência e propor critérios para localização de empreendimentos, serviços ou campanhas.
6. Elaborar mapas temáticos, indicadores territoriais e relatórios analíticos voltados à tomada de decisão.
7. Discutir aspectos éticos, legais e sociais relacionados ao uso de dados espaciais e de consumidores.

## Planejamento de encontros síncronos

Os encontros acontecerão nas **terças e quintas-feiras**, de **18:50 às 20:30**.
...
| Unidade 02 - Espaço geográfico, consumo e localização | 18/08 | 2h | Comportamento do consumidor e localização. Atividade em sala 2 |
| Unidade 03 - Dados para geomarketing | 20/08 | 2h | Dados censitários, bases públicas e dados abertos |
| Unidade 03 - Dados para geomarketing | 25/08 | 2h | Dados corporativos, pesquisas de mercado e dados transacionais |
| Unidade 03 - Dados para geomarketing | 27/08 | 2h | Dados digitais: origens, formatos e potencial para geomarketing |
| Unidade 03 - Dados para geomarketing | 01/09 | 2h | Qualidade, escala, atualização e limitações dos dados espaciais |
| Unidade 03 - Dados para geomarketing | 03/09 | 2h | Atividade em sala 3 – exploração de bases de dados |
...
Site da disciplina: <https://www.places.education/disciplinas/geomarketing/>

## Bibliografia recomendada

1. LONGLEY, Paul A.; GOODCHILD, Michael F.; MAGUIRE, David J.; RHIND, David W. **Sistemas e ciência da informação geográfica**. 3. ed. Porto Alegre: Bookman, 2013.
2. KOTLER, Philip; KELLER, Kevin Lane. **Administração de marketing**. 15. ed. São Paulo: Pearson, 2019.
3. OLIVEIRA, Paulo Henrique Pinho de. **Geointeligência: como o geomarketing revoluciona o mundo dos negócios**. [S. l.]: UICLAP, 2024.
4. SEBASTIÃO, André. **A crescente importância da privacidade e segurança no geomarketing**. Amazon, 2023.
5. SEBASTIÃO, André. **A evolução do geomarketing: tecnologias emergentes para empresas**. Amazon, 2023.
6. SEBASTIÃO, André. **Geomarketing preditivo: comportamentos, antecipando necessidades**. [S. l.]: Amazon, 2023.
7. ROCHA, Marcos Donizete Aparecido; SOUSA, José Manuel Baptista Meireles de. **Canais de distribuição e geomarketing**. São Paulo: Saraiva Uni, 2017.
