...
menu:
  intro_r:
    parent: 8 - Segmentação de mercado
    weight: 90
...
Salve o arquivo em [mall.csv](https://www.dropbox.com/s/yh1q8j7h7advv2h/mall.csv?dl=0).

```{r echo=TRUE, message=FALSE, warning=FALSE}

customer_data=read_delim("D:/Dropbox/Public/mall.csv", delim = ";", escape_double = FALSE, trim_ws = TRUE)
