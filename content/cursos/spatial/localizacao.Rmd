...
Ao final deste curso, os alunos deverão ser capazes de discutir os seguintes conceitos:  
...
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/pensamento_espacial.png')
```
...
```{r echo=FALSE, out.width='50%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/gravidade_terra.png')
```
...
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/geoide.png')
```
...
```{r echo=FALSE, out.width='30%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/elipsoi_1.png')
```

```{r echo=FALSE, out.width='30%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/elipsoide_2.png')
```
...
```{r echo=FALSE, out.width='50%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/datum.png')
```

- Datum Horizontal ou Planimétrico: referência para coordenadas planimétricas   
```{r echo=FALSE, out.width='30%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/geoide_geocentrico.png')
```

```{r echo=FALSE, out.width='30%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/geoide_topocentrico.png')
```
...
```{r echo=FALSE, out.width='30%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/graus.png')
```
...
```{r echo=FALSE, out.width='30%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/lat_long.png')
```
...
```{r echo=FALSE, out.width='30%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/projecao.png')
```
...
```{r echo=FALSE, out.width='30%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/laranja1.png')
```

```{r echo=FALSE, out.width='30%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/laranja 2.png')
```

Representar uma superfície curva (a Terra) em um plano sempre envolve deformações. **Não existe projeção ideal**.     

```{r echo=FALSE, out.width='30%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/erro_proj1.png')
```

```{r echo=FALSE, out.width='30%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/proj.jpg')
```
...
```{r echo=FALSE, out.width='30%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/planotangente.png')
```

- Secante

```{r echo=FALSE, out.width='30%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/planosecante.png')
```
...
```{r echo=FALSE, out.width='30%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/mercartor.png')
```
...
```{r echo=FALSE, out.width='30%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/utm.png')
```

```{r echo=FALSE, out.width='30%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/utm_br.png')
```

```{r echo=FALSE, out.width='30%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/utm1.png')
```

```{r echo=FALSE, out.width='30%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/utm2.png')
```

```{r echo=FALSE, out.width='30%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/utm5.png')
```
...
```{r echo=FALSE, out.width='30%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/vector-vs-raster.png')
```
...
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/q1.png')
```

**2. Complementos**   

```{r echo=FALSE, out.width='60%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/q2.png')
```
...
```{r echo=FALSE, out.width='60%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/q3.png')
```

```{r echo=FALSE, out.width='60%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/q4.png')
```
...
```{r echo=FALSE, out.width='60%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/q7.png')
```

- Recursos para alteração da representação das feições nas camadas    

```{r echo=FALSE, out.width='60%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/q5.png')
```
...
```{r echo=FALSE, out.width='60%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/q8.png')
```
...
```{r echo=FALSE, out.width='60%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/q9.png')
```

```{r echo=FALSE, out.width='60%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/q10.png')
```

```{r echo=FALSE, out.width='60%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/q11.png')
```

```{r echo=FALSE, out.width='60%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/q12.png')
```
...
```{r echo=FALSE, out.width='60%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/q13.png')
```

```{r echo=FALSE, out.width='60%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/q14.png')
```
...
```{r echo=FALSE, out.width='60%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/q17.png')
```


```{r echo=FALSE, out.width='60%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/q18.png')
```
...
```{r echo=FALSE, out.width='60%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/q16.png')
```
...
```{r echo=FALSE, out.width='60%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/q22.png')
```

```{r echo=FALSE, out.width='60%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/q23.png')
```

```{r echo=FALSE, out.width='60%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/q24.png')
```

```{r echo=FALSE, out.width='60%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/q25.png')
```


```{r echo=FALSE, out.width='60%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/q26.png')
```
...
```{r echo=FALSE, out.width='60%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/q19.png')
```
...
```{r echo=FALSE, out.width='60%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/q20.png')
```
...
```{r echo=FALSE, out.width='60%'}
knitr::include_graphics('https://retaoliveira.github.io/relements/figures/q21.png')
```
